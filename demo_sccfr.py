...
def check_json(args, js_result):
    ...
    for data in js_result['data']:
        ...
        if flag == 1:
            print('find a result of the same parameter setting.')
            sys.exit()
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Run SC-CFR')
    # Experiment setting
    ...
    # Model setting
    parser.add_argument('--model', type=str, default="SC-CFR")
